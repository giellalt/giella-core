...
automatically when running `./autogen.sh` in a `lang` repo for the first time.

Some further documentation can be found on
[the project site](https://giellalt.github.io/giella-core).
