...
alias crkeng1="$LOOKUP $GTHOME/words/dicts/crkeng/bin/crkeng-first.fst"
alias engsme1="$LOOKUP $GTHOME/words/dicts/engsme/bin/engsme-first.fst"
alias finkpv1="$LOOKUP $GTHOME/words/dicts/finkpv/bin/finkpv-first.fst"
alias finkrl1="$LOOKUP $GTHOME/words/dicts/finkrl/bin/finkrl-first.fst"
alias finnob1="$LOOKUP $GTHOME/words/dicts/finnob/bin/finnob-first.fst"
alias finsme1="$LOOKUP $GTHOME/words/dicts/finsme/bin/finsme-first.fst"
alias finsmn1="$LOOKUP $GTHOME/words/dicts/finsmn/bin/finsmn-first.fst"
alias finsms1="$LOOKUP $GTHOME/words/dicts/finsms/bin/finsms-first.fst"
alias fitswe1="$LOOKUP $GTHOME/kvensk/fitswe/bin/fitswe-first.fst"
alias fkvnob1="$LOOKUP $GTHOME/words/dicts/fkvnob/bin/fkvnob-first.fst"
alias hdneng1="$LOOKUP $GTHOME/words/dicts/hdneng/bin/hdneng-first.fst"
alias kaldan1="$LOOKUP $GTHOME/words/dicts/kaldan/bin/kaldan-first.fst"
alias kaleng1="$LOOKUP $GTHOME/words/dicts/kaleng/bin/kaleng-first.fst"
alias kpvfin1="$LOOKUP $GTHOME/words/dicts/kpv2X/bin/kpvfin-first.fst"
alias mhreng1="$LOOKUP $GTHOME/words/dicts/mhreng/bin/mhreng-first.fst"
alias mhrmrj1="$LOOKUP $GTHOME/words/dicts/mhrmrj/bin/mhrmrj-first.fst"
alias mhrrus1="$LOOKUP $GTHOME/words/dicts/mhrrus/bin/mhrrus-first.fst"
alias myvmdf1="$LOOKUP $GTHOME/words/dicts/myvmdf/bin/myvmdf-first.fst"
alias myvmdf1="$LOOKUP $GTHOME/words/dicts/nobfkv/bin/myvmdf-first.fst"
alias nobfin1="$LOOKUP $GTHOME/words/dicts/nobfin/bin/nobfin-first.fst"
alias nobfkv1="$LOOKUP $GTHOME/words/dicts/nobfkv/bin/nobfkv-first.fst"
alias nobsma1="$LOOKUP $GTHOME/words/dicts/nobsma/bin/nobsma-first.fst"
alias nobsme1="$LOOKUP $GTHOME/words/dicts/nobsme/bin/nobsme-first.fst"
alias nobsmj1="$LOOKUP $GTHOME/words/dicts/nobsmj/bin/nobsmj-first.fst"
alias smanob1="$LOOKUP $GTHOME/words/dicts/smanob/bin/smanob-first.fst"
alias smasme1="$LOOKUP $GTHOME/words/dicts/smasme/bin/smasme-first.fst"
alias smeeng1="$LOOKUP $GTHOME/words/dicts/smeeng/bin/smeeng-first.fst"
alias smefin1="$LOOKUP $GTHOME/words/dicts/smefin/bin/smefin-first.fst"
alias smenob1="$LOOKUP $GTHOME/words/dicts/smenob/bin/smenob-first.fst"
alias smesma1="$LOOKUP $GTHOME/words/dicts/smesma/bin/smesma-first.fst"
alias smesmj1="$LOOKUP $GTHOME/words/dicts/smesmj/bin/smesmj-first.fst"
alias smesmn1="$LOOKUP $GTHOME/words/dicts/smesmn/bin/smesmn-first.fst"
alias smsfin1="$LOOKUP $GTHOME/words/dicts/smsfin/bin/smsfin-first.fst"
alias smespa1="$LOOKUP $GTHOME/words/dicts/smespa/bin/smespa-first.fst"
alias mnshun1="$LOOKUP $GTHOME/words/dicts/mnshun/bin/mnshun-first.fst"
alias smjsme1="$LOOKUP $GTHOME/words/dicts/smesmj/bin/smjsme-first.fst"
alias smnfin1="$LOOKUP $GTHOME/words/dicts/smnfin/bin/smnfin-first.fst"
alias smnsme1="$LOOKUP $GTHOME/words/dicts/smnsme/bin/smnsme-first.fst"
alias spasme1="$LOOKUP $GTHOME/words/dicts/spasme/bin/spasme-first.fst"
alias srseng1="$LOOKUP $GTHOME/words/dicts/srseng/bin/srseng-first.fst"
alias swefit1="$LOOKUP $GTHOME/words/dicts/swefit/bin/swefit-first.fst"
