...
alias dkoi='$LOOKUP $GTHOME/langs/koi/src/generator-gt-desc.xfst'
...
alias ukoi='$LOOKUP $GTHOME/langs/koi/src/analyser-gt-desc.xfst'
...
alias dkoiNorm='$LOOKUP $GTHOME/langs/koi/src/generator-gt-norm.xfst'
...
alias ukoiNorm='$LOOKUP $GTHOME/langs/koi/src/analyser-gt-norm.xfst'
...
alias hdkoi='$HLOOKUP $GTHOME/langs/koi/src/generator-gt-desc.hfstol'
...
alias hukoi='$HLOOKUP $GTHOME/langs/koi/src/analyser-gt-desc.hfstol'
...
alias husjedis='$HLOOKUP $GTHOME/langs/sje/src/analyser-disamb-gt-desc.hfstol'
...
alias husmsdis='$HLOOKUP $GTHOME/langs/sms/src/analyser-disamb-gt-desc.hfstol'
...
alias hdkoiNorm='$HLOOKUP $GTHOME/langs/koi/src/generator-gt-norm.hfstol'
...
alias hukoiNorm='$HLOOKUP $GTHOME/langs/koi/src/analyser-gt-norm.hfstol'
...
alias kpvtoks="hfst-tokenise --giella-cg $GTHOME/langs/kpv/tools/tokenisers/tokeniser-disamb-gt-desc.pmhfst | \
               vislcg3 -g $GTHOME/langs/kpv/src/cg3/disambiguator.cg3 | \
               sed 's/ <W:0.0000000000>//g;'"
alias kpvtokst="hfst-tokenise --giella-cg $GTHOME/langs/kpv/tools/tokenisers/tokeniser-disamb-gt-desc.pmhfst | \
               vislcg3 -g $GTHOME/langs/kpv/src/cg3/disambiguator.cg3 -t | \
               sed 's/ <W:0.0000000000>//g;'"

alias myvtoka="hfst-tokenise --giella-cg $GTHOME/langs/myv/tools/tokenisers/tokeniser-disamb-gt-desc.pmhfst | \  
               sed 's/ <W:0.0000000000>//g;'"
alias myvtoks="hfst-tokenise --giella-cg $GTHOME/langs/myv/tools/tokenisers/tokeniser-disamb-gt-desc.pmhfst |  vislcg3 -g $GTHOME/langs/myv/src/cg3/disambiguator.cg3 | \  
               sed 's/ <W:0.0000000000>//g;'"
alias myvtokst="hfst-tokenise --giella-cg $GTHOME/langs/myv/tools/tokenisers/tokeniser-disamb-gt-desc.pmhfst | vislcg3 -g $GTHOME/langs/myv/src/cg3/disambiguator.cg3 -t | \  
               sed 's/ <W:0.0000000000>//g;'"
