...
<!--+
    ...
    |
    | - parameter to adjust:
    |   - input dir: inDir; default is ../../dict-SLANG-mul/src (e.g., ../../dict-sma-mul/src)
    |   - output dir: outDir; default is ../../dict-SLANG-mul/bin (e.g., ../../dict-sma-mul/bin)
    |
    |  CAVEAT: inDir and outDir should be given as relative to where
    |                 this script is called from; the defaults are relative to 
    |                   (a) the script being giella-core/dicts/scripts
    |                        and
    |                   (b) the calling place being giella-core/dicts
    |
